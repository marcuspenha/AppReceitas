...
const styles = StyleSheet.create({
  ...
  card:            { backgroundColor: colors.white, marginHorizontal: 16,
  ...
  itemDescription: { fontSize: 12, color: colors.textLight, marginTop: 1 },
  itemArrow:       { fontSize: 22, color: colors.textLight },
  separator:       { height: 1, backgroundColor: colors.background, marginLeft: 68 },
  logoutButton:    { margin: 16, marginTop: 20, backgroundColor: colors.white,
                     borderWidth: 1.5, borderColor: '#C0392B', borderRadius: 12,
                     paddingVertical: 14, alignItems: 'center' },
  logoutText:      { color: '#C0392B', fontSize: 15, fontWeight: '700' },
  version:         { textAlign: 'center', fontSize: 12,
                     color: colors.textLight, marginBottom: 32 },
});